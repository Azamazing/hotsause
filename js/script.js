...
formAgree.addEventListener("change", () => {
  formAgree.checked
  ...
  item.addEventListener("click", () => {
    if (item.classList.contains("accordion__item--opened")) {
      ...
      accordionItems.forEach((i) =>
        i.classList.remove("accordion__item--opened")
      );
  ...
  item.addEventListener("click", () => {
    accordionItems.forEach((i) =>
      i.classList.toggle(
        ...
        i === item && !item.classList.contains("accordion__item--opened")
      )
    );
  });
}); */
...
document.querySelector(".gamburger").addEventListener("click", function () {
  ...
  document
    .querySelector(".header__gamburger-panel")
    .classList.toggle("header__gamburger-panel--show");
